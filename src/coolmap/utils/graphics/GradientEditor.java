...
public class GradientEditor extends JPanel {
	...
	private JButton add = null; //new JButton("Add");
	/** A button to edit a control point */
	private JButton edit = null; //new JButton("Edit");
	/** A button to delete a control point */
	private JButton del = null; //new JButton("Del");
	...
	public GradientEditor() {
		setLayout(null);
                ...
                add = new JButton(UI.getImageIcon("plusSmall"));
                edit = new JButton(UI.getImageIcon("pen"));
                del = new JButton(UI.getImageIcon("minusSmall"));
