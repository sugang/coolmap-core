 ...
 * @author Keqiang Li
 */
public abstract class TestTask implements Callable<Boolean>, ActiveCoolMapChangedListener {
    
    private Queue<List<String>> nodesListToExpand;
    ...
    public TestTask(final List<VNode> initialNodes, final Map<VNode, Integer> mappings, long timeInterval, CoolMapObject obj) {
