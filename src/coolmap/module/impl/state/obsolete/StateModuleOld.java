 ...
 */
package coolmap.module.impl.state.obsolete;
 ...
 * @author gangsu
 */
public class StateModuleOld extends Module implements ActiveCoolMapChangedListener, CObjectListener {

    private MenuItem _undoOperation;
    private MenuItem _redoOperation;

    public StateModuleOld() {
